    ...
    return (
        ...
        <section className=" mt-[65px] mb-[15px] h-[100px]">
            ...
            <div className="flex flex-col items-center justify-center py-0 px-[30px] sm:px-[60px] w-full gap-[6px] sm:gap-[10px]">
                <p className="text-[14px] sm:text-[20px]  text-(--color-thriColor) uppercase">don't miss super offers</p>

                <h2 className="text-[24px] sm:text-[32px]  text-(--color-primaryColor) ">Our best products</h2>
            </div>
