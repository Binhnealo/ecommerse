...
import CountdownTimer from "@components/CountdownTimer/CountdownTimer";
    ...
    return (
        <div className="flex gap-[20px] flex-col items-center justify-start sm:justify-center  w-full h-[410px] bg-contain bg-no-repeat sm:bg-cover bg-[url(https://xstore.8theme.com/elementor2/marseille04/wp-content/uploads/sites/2/2022/12/photo-of-man-wearing-white-hoodie-5474310.jpeg)]">
